...
| Repo | Qtr | Moderator | github users | Description |
| --- | --- | --------- | ------------ | -----------  |
| [conversion-quiz](https://github.com/UCSB-CS56-Projects/cs56-math-conversion-quiz)  | W14 | bronhuston 5pm |  ashedden,l-y-s | GUI for binary/octal/hex/decimal conversion quiz |
...
| Repo | Qtr | Moderator | github users | Description |
| --- | --- | --------- | ------------ | -----------  |
| [chat](https://github.com/UCSB-CS56-Projects/cs56-networking-chat)  | W14 | jcneally 4pm |      ericchen94 | A chat application that uses a client and a server |
...
| Repo | Qtr | Moderator | github users | Description |
| --- | --- | --------- | ------------ | -----------  |
| [image-zoom](https://github.com/UCSB-CS56-Projects/cs56-tutorials-image-zoom)  | W14 | jstaahl 5pm | derek-x-wang,RexLang | (kjorg50) A tutorial illustrating how to do simple zoom in and zoom out controls on, for example, a map image. |
